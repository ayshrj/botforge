...
export const skinColorOptions: readonly ColorOption[] = [
  ...
  { id: "skin-light", label: "Light", value: "#EDC4AA" },
  { id: "skin-peach", label: "Peach", value: "#E5AE8C" },
  { id: "skin-warm", label: "Warm", value: "#D99B73" },
  { id: "skin-tan", label: "Tan", value: "#C9825F" },
  { id: "skin-brown", label: "Brown", value: "#A96346" },
  { id: "skin-deep", label: "Deep", value: "#784634" },
  { id: "skin-dark", label: "Dark", value: "#553126" },
] as const;

export const hairColorOptions: readonly ColorOption[] = [
  { id: "hair-black", label: "Black", value: "#171719" },
  { id: "hair-charcoal", label: "Charcoal", value: "#29292E" },
  { id: "hair-dark-brown", label: "Dark Brown", value: "#493126" },
  { id: "hair-brown", label: "Brown", value: "#6A4530" },
  { id: "hair-chestnut", label: "Chestnut", value: "#874A31" },
  { id: "hair-auburn", label: "Auburn", value: "#9A4937" },
  { id: "hair-copper", label: "Copper", value: "#B9673F" },
  { id: "hair-blonde", label: "Blonde", value: "#D8B56E" },
  { id: "hair-light-blonde", label: "Light Blonde", value: "#E6CF94" },
  { id: "hair-silver", label: "Silver", value: "#B9BBC2" },
  { id: "hair-blue", label: "Blue", value: "#536FA8" },
  { id: "hair-pink", label: "Pink", value: "#C76685" },
] as const;
...
export const accessoryOptions = getRegistryIds<
  Extract<NonNullable<AvatarConfig["accessory"]>, string>
